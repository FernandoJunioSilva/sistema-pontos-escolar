...
const imagensGaleria = [foto1, foto2, foto3, foto5, foto6, foto7, foto8, foto9, foto10];
  ...
  return (
    <div className="site-escola-page">
      <header className="escola-topo">
        <div className="escola-topo-info">
          <a
          ...
          <a
            href="https://www.bing.com/search?q=zinha%20meira"
            target="_blank"
            rel="noreferrer"
          >
            📍 Bocaiuva - MG
      ...
      <header className="escola-cabecalho">
        <button className="escola-logo" type="button" onClick={() => trocarAba('inicio')}>
      ...
      <main>
        {abaAtiva === 'inicio' && (
          <section className="escola-aba">
            ...
            <section className="escola-servicos">
              ...
              <div className="escola-titulo-icone">📖</div>
              <div className="escola-linha" />

              <div className="escola-cards">
                <article className="escola-card escola-card-servico">
                  <div className="escola-card-icone">📚</div>
            ...
            <section className="escola-novidades-botao">
              <button type="button" onClick={() => setMostrarNovidades((valor) => !valor)}>
                <span>📰</span>
                <strong>Novidades</strong>
                <small>Clique para conferir as últimas notícias da escola.</small>
              </button>
            </section>
            ...
            {mostrarNovidades && (
              <section className="escola-novidades">
                ...
                <div className="escola-noticia">
                  <h3>Projeto de Leitura</h3>
                  <p>
                    A Escola Estadual Zinha Meira realizou atividades de incentivo à leitura com
        ...
        {abaAtiva === 'sobre' && (
          <section className="escola-aba escola-container">
            <section className="escola-galeria-destaque">
            ...
            <section className="escola-card escola-texto-card">
              ...
              <p>
                Criada inicialmente como Jardim de Infância Zinha Meira pelo Decreto nº 10.690, de
                20 de setembro de 1967, a instituição iniciou suas atividades em 31 de março de
            ...
            <section className="escola-card escola-texto-card">
              ...
              <div className="escola-lista-blocos">
                <article>
                ...
                <article>
                  <h3>Ensino Médio Integral</h3>
                  <p>
                    O Programa de Ensino Médio Integral busca desenvolver o estudante em todas as
                    suas dimensões, tendo como foco o Projeto de Vida, o protagonismo juvenil, a
                    autonomia e a formação cidadã.
                  </p>
                </article>
                ...
                <article>
                  ...
                  <p>
                    Modalidade destinada às pessoas que não tiveram acesso ou continuidade dos
                    estudos na idade apropriada, valorizando suas experiências de vida e oferecendo
            ...
            <section className="escola-card escola-texto-card">
              ...
              <p>
                ...
                espaços públicos de aprendizagem, cultura, esporte e saúde, favorecendo o
                desenvolvimento integral dos estudantes.
              </p>
              <p>
                Cerca de <strong>70% dos alunos</strong> residem próximos à escola, fortalecendo a
                relação entre instituição, comunidade e família.
              </p>
        ...
        {abaAtiva === 'saiba' && (
          <section className="escola-aba escola-container">
            <section className="escola-hero-info">
            ...
            <section className="escola-card escola-texto-card">
              ...
              <div className="escola-timeline">
                <div className="escola-timeline-item">
                  <span>1967</span>
        ...
        {abaAtiva === 'contatos' && (
          <section className="escola-aba escola-container">
            <section className="escola-servicos escola-contatos-area">
              <h2>Entre em Contato</h2>
              <div className="escola-titulo-icone">📖</div>
              <div className="escola-linha" />

              <div className="escola-cards">
                <article className="escola-card escola-contato-card">
                  <div className="escola-contato-icone instagram">📷</div>
                  <h3>Instagram</h3>
                  <p>@terceirao.inf26</p>
                </article>

                <article className="escola-card escola-contato-card">
                  <div className="escola-contato-icone telefone">☎️</div>
                  <h3>Telefone</h3>
                  <p>(38)932511732</p>
                </article>

                <article className="escola-card escola-contato-card">
                  <div className="escola-contato-icone email">✉️</div>
                  <h3>E-mail</h3>
      ...
      <footer className="escola-rodape">
        <p>Rua Presidente Juscelino Kubitschek, 615 – Pernambuco, Bocaiuva/MG – CEP 39390-000</p>
